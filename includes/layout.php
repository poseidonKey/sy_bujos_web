    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="/sy_bujos_web/bujos/">부조 목록</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/sy_bujos_web/categories/">카테고리</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/sy_bujos_web/statistics/">통계</a>
                    </li>
                </ul>
            </div>
        </div>
