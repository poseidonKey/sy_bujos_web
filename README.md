...
- **대시보드**: 전체 부조 현황, 완료 건수/금액, 빠른 링크
- **부조 관리**: 목록 조회, 카테고리 필터, CRUD 기능
- **카테고리 관리**: 카테고리 분류 및 관리
- **통계**: 카테고리별 건수/금액 집계, 비중 표시
...
- [x] 프로젝트 디렉토리 구조
- [x] Composer 의존성 설정
- [x] Firestore REST API 클라이언트 (gRPC 없이 동작)
- [x] Firebase 서비스 계정 연동
- [x] 기본 레이아웃 및 함수
- [x] 대시보드 페이지
- [x] 부조 관리 (목록/생성/수정/삭제)
- [x] 카테고리 관리 (목록/생성/수정/삭제)
- [x] 통계 페이지 (카테고리별 집계)
